...
document.getElementById('contact-form').addEventListener('submit', function(event) {
    ...
    const phoneValid = phonePattern.test(phoneInput);
        ...
        const mailtoLink = `mailto:info@beykentservisotolastik.com.tr?subject=${subjectInput}&body=\Ad: ${nameInput}%0D%0A\E-posta: ${emailInput}%0D%0A\Telefon: ${phoneInput}%0D%0A\Mesaj: ${messageInput}`;
